...
register_mjlab_task(
  task_id="Mjlab-Velocity-Flat-Pal-Talos-Tray-Contact-Grasp-Oracle-2p5-15kg",
  env_cfg=pal_talos_grasping_oracle_mass_tray_flat_env_cfg(),
  play_env_cfg=pal_talos_grasping_oracle_mass_tray_flat_env_cfg(play=True),
  rl_cfg=pal_talos_grasping_oracle_mass_tray_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
